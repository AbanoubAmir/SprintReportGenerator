...
public interface IAzureDevOpsClient
{
    ...
    Task<IReadOnlyList<WorkItem>> GetWorkItemsByDateRangeAsync(DateTime startDate, DateTime endDate, string excludeIterationPath, HashSet<string> teamMemberNames, CancellationToken cancellationToken);
}
